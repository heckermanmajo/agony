  ...
  do
    ...
    for index, squad_template in ipairs(squads) do
      ...
      if Utils.mouse_is_over(icon_x, icon_y, 64, 64) then
        ...
        local i_have_enough_money = Battle.current.player_army.command_points >= costs_in_command_points
        ...
        if love.mouse.isDown(1) and UiState.key_press_cooldown <= 0 and i_have_enough_money then
          ...
          Battle.current.player_army.command_points = Battle.current.player_army.command_points - costs_in_command_points
